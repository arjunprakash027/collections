...
class FrameApp(Frame):
    ...
    def play_music(self):
        ...
        #Loads current song, plays it, sets event on song finish :return: None
    ...
    def check_music(self):
        ...
        #Listens to END_MUSIC event and triggers next song to play if current song has finished 
    ...
    def get_previous_song(self):
        ...
        #Gets previous song number on playlist
